...
public class Library extends JFrame{
 ...
 public void actionPerformed(ActionEvent e) {
 if(sortType == SORT_TITLE)Bookshelfs.sortByTitle(ascending.isSelected(), shelfAsItIsNow);
 if(sortType == SORT_AUTHOR)Bookshelfs.sortByAuthor(ascending.isSelected(), shelfAsItIsNow);
 if(sortType == SORT_SIZE)Bookshelfs.sortByHeight(ascending.isSelected(), shelfAsItIsNow);
 if(sortType == SORT_LENGTH)Bookshelfs.sortByPageNumber(ascending.isSelected(), shelfAsItIsNow);
 redoBookImage();
 repaint();
 }
 });
